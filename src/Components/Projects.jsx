      ...
      <div className='max-w-5xl mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: false, amount: 0.3 }}
            className='p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-green-500/30 hover:shadow-[0_2px_8px_rgba(34,197,94,0.2)] transition'
          >
